...
translations = {
    'en': {
        ...
        'good_luck': "Good Luck!",
        'choose_source':
        "Do you want to use pre-stored words or enter your own words? (pre-stored/enter): ",
...
def choose_word_source(language):
    """
    Permite al usuario seleccionar una fuente de palabras 
    (prealmacenadas o propias) y devuelve una palabra aleatoria de la fuente elegida.
...
while turns > 0:
    ...
    if failed == 0:
        ...
        scores += 1
        print(translations[language]['current_score'], scores)
        break
...
print(translations[language]['final_score'], scores)
